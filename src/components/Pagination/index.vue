<template>
  <div id="pagination">
    <nav class="pagination is-centered">
      <a class="pagination-previous" v-if="current > 1" @click="onChange(current - 1)">&lt;</a>
      <a class="pagination-next" v-if="size > 1 && current < size" @click="onChange(current + 1)"> &gt;</a>
...
import EllipseBreak from './components/EllipseBreak.vue'
export default {
  name: 'pagination',
